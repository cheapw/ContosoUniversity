    ...
    public class DbInitializer
    {
        public static void Initialize(SchoolContext context)
        {
            ...
            var instructors = new Instructor[]
            {
                ...
                new Instructor{FirstMidName="Fadi",LastName="Fakhouri",HireDate=DateTime.Parse("1995-03-11") },
            ...
            var courses = new Course[]
            {
                ...
                new Course{CourseID=2021,Title="Literature",Credits=4,
                DepartmentID=departments.Single(s=>s.Name=="English").DepartmentID}
            };
            ...
            var officeAssignments = new OfficeAssignment[]
            {
                ...
                new OfficeAssignment{ InstructorID=instructors.Single(i=>i.LastName=="Harui").ID,Location="Gowan" },
